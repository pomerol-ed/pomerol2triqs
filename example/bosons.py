...
# Hubbard atom coupled to two bosonic modes
...
n_bits = 3          # Consider occupations of bosonic modes 0 ... 2^3 - 1
...
index_converter = {("up", 0): ("loc", 0, "up"), ("dn", 0): ("loc", 0, "down")}

# Make PomerolED solver object
ed = PomerolED(index_converter, verbose = True)

# Number of particles on the atom
N = sum(n(sn, 0) for sn in spin_names)

# Hamiltonian (purely fermionic part)
...
if mpi.is_master_node():
    with HDFArchive('bosons.h5', 'w') as ar:
